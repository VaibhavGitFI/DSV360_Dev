...
;
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.error("Validation failed:", errors); // Debugging
    }
  };
...
const handleSaveCVWithValidation = async () => {
  if (!cvFile) {
  ...
  setLoading(true);
  try {
    await handleSaveCVWithLoader(); // your existing save logic
  } finally {
    setLoading(false);
  }
};
      ...
      {badges && badges.length > 0 ? (
        ...
        >
          {badges.map((badge, index) => (
            <Chip
              key={index}
              avatar={<Avatar src={badge.Badge_Logo} alt={`Badge ${index + 1}`} />}
              label={`${badge.Badge_Name} - ${badge.Badge_Level}`}
              sx={{
                borderRadius: "12px",
                height: 46,
                fontWeight: 600,
...
>
  ...
  <Box sx={{ position: "relative", display: "inline-block" }}>
    <Box
      component="img"
      src="https://cdn-public.softwarereviews.com/production/logos/offerings/4979/original/zoho-people_logo.png?1732042331"
      alt="Zoho People"
      sx={{
        height: 42,
        bgcolor: "#fff",
  ...
  <Box sx={{ position: "relative", display: "inline-block" }}>
    <Box
      component="img"
      src="https://cdn-public.softwarereviews.com/production/logos/offerings/231/original/zoho-books_logo.png?1742241915"
      alt="Zoho Books"
      sx={{
        height: 42,
        bgcolor: "#fff",
  ...
  <Box sx={{ position: "relative", display: "inline-block" }}>
    <Box
      component="img"
      src="https://shopiverse.com/wp-content/uploads/2024/05/zoho-crm.webp"
      alt="Zoho CRM"
      sx={{
        height: 42,
        bgcolor: "#fff",
   ...
   <Box sx={{ position: "relative", display: "inline-block" }}>
    <Box
      component="img"
      src="https://sm.pcmag.com/pcmag_me/review/z/zoho-analy/zoho-analytics_6c58.png"
      alt="Zoho Analytics"
      sx={{
        height: 42,
        bgcolor: "#fff",
                        ...
                        >
                          <Typography
                            ...
                            sx={{
                              lineHeight: 1.7,
                              color: "text.secondary",
                              display: "inline-block", // necessary for nowrap to work
                              whiteSpace: "nowrap",
                            }}
                          >
...
<Box
    ...
    {skills.map((skill, index) => (
      <Chip
        ...
        sx={{
          ...
          borderColor: alpha(theme.palette.primary.main, 0.2),
          transition: "all 0.2s ease",
          whiteSpace: "nowrap", // important for horizontal scrolling
          "&:hover": {
            backgroundColor: alpha(theme.palette.primary.main, 0.15),
            boxShadow: "0 2px 8px rgba(0,0,0,0.08)",
          },
  ...
  >
                {apps.map((app, index) => (
                  <Chip
                    key={index}
                    avatar={<Avatar src={app.logo} alt={app.name} />}
                    label={app.name}
                    sx={{
                      borderRadius: "12px",
                      height: 46,
      ...
      >
        ...
        <DialogContent sx={{ position: "relative" }}>
          <Input
            type="file"
  inputProps={{ accept: ".pdf" }} // ✅ Correct way for MUI Input
    ...
    {/* Validation message */}
    {!cvFile && showValidation && (
      <Typography variant="body2" sx={{ mt: 1, color: "error.main" }}>
        Please upload your CV before saving.
      </Typography>
    )}
        ...
        <DialogActions>
          ...
          <Button
            color="primary"
            variant="contained"
            onClick={handleSaveCVWithValidation}
            disabled={loading}
          >
