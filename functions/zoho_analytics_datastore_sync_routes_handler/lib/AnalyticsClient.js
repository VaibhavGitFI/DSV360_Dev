...
const domain = env === 'Production' ? '.com' : '.in';

const analyticsURI = `analyticsapi.zoho${domain}`;
const accountsURI = `accounts.zoho${domain}`;
const clientVersion = '2.1.0';

console.log("Analytics URI =", analyticsURI);
console.log("Accounts URI =", accountsURI);
