class AppConstants {
  ...
  static Env = {
    ...
    AuthHost: 'AUTH_HOST',
    Projects_ClientId: 'PROJECTS_CLIENT_ID',
    Projects_ClientSecret: 'PROJECTS_CLIENT_SECRET',
    Projects_RefreshToken: 'PROJECTS_REFRESH_TOKEN',
    Projects_AuthHost: 'PROJECTS_AUTH_HOST'
